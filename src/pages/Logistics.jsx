                    ...
                    <form onSubmit={handleCreateTransfer} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 items-end">
                        <div className="space-y-2">
                            ...
                            >
                                ...
                                {products.map(p => (
                                    <option key={p.id} value={p.id}>{p.name} ({p.warehouse?.name || 'Factory'})</option>
                                ))}
                            </select>
                        </div>
                        <div className="space-y-2">
                                ...
                                <tr key={t.id} className="hover:bg-slate-50/50 transition-colors group">
                                    <td className="px-6 py-4">
                                        <div className="flex items-center space-x-3">
                                            ...
                                            <div>
                                                <p className="text-[11px] font-bold text-slate-900 tracking-wide mb-0.5">#{(t.id || '').toString().slice(-6).toUpperCase()}</p>
