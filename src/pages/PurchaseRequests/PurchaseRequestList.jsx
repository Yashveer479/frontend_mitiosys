...
import { 
    ...
    AlertCircle, Layers, User, Calendar
} from 'lucide-react';

const PurchaseRequestList = ({ requests, loading, onViewDetails }) => {
    if (loading) {
        return (
                        ...
                        <tr key={request.id} className="hover:bg-slate-50/50 transition-colors group">
                            ...
                            <td className="px-6 py-4">
                                <button
                                    ...
                                    className="p-2 bg-slate-100 rounded-lg text-slate-400 hover:text-blue-600 hover:bg-blue-50 transition-all opacity-0 group-hover:opacity-100"
                                >
