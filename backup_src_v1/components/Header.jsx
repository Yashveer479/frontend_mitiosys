...
import { Search, Bell, User, Clock, Globe, ArrowUpRight, ArrowDownRight, Zap } from 'lucide-react';
                    ...
                    <div className="flex items-center space-x-2">
                        ...
                        <button onClick={() => window.location.href = '/profile'} className="flex items-center space-x-3 pl-4 border-l border-slate-100 cursor-pointer group text-left">
                            <div className="hidden sm:block">
                                <p className="text-sm font-black text-slate-800 leading-none mb-1 group-hover:text-blue-600 transition-colors">Alex Johnson</p>
                                <p className="text-[9px] text-slate-400 font-black uppercase tracking-[0.2em] leading-none">EXECUTIVE OPS</p>
                            </div>
                            <div className="w-10 h-10 rounded-xl bg-slate-100 flex items-center justify-center text-slate-400 border border-slate-100 group-hover:border-blue-200 group-hover:bg-blue-50 group-hover:text-blue-600 transition-all shadow-sm overflow-hidden">
                                <User size={20} />
                            </div>
                        </button>
                    </div>
