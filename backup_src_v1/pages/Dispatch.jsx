...
const Dispatch = () => {
    ...
    useEffect(() => {
        // Mock Data: Fetch Orders ready for dispatch
        const mockOrders = [
            { id: 'ORD-2026-5591', customer: 'Kampala Builders', location: 'Industrial Area', items: 3, status: 'Packed', date: '2026-02-17' },
            { id: 'ORD-2026-5592', customer: 'Entebbe Construction', location: 'Entebbe Road', items: 12, status: 'Picked', date: '2026-02-16' },
            { id: 'ORD-2026-5593', customer: 'Mukono Hardware', location: 'Mukono Town', items: 8, status: 'Ready', date: '2026-02-18' },
        ];
    ...
    const handleDispatch = (e) => {
        ...
        setTimeout(() => {
            ...
            setSuccess(true);
            setTimeout(() => {
                // Remove processed order from list (simulated)
                                ...
                                {orders.map(order => (
                                    ...
                                    >
                                        <div className="flex justify-between items-start mb-2">
                                            <span className={`text-[10px] font-black uppercase tracking-widest ${selectedOrder?.id === order.id ? 'text-blue-600' : 'text-slate-500'}`}>{order.id}</span>
                                    ...
                                    <div className="flex justify-between items-start mb-8">
                                        <div>
                                            ...
                                            <p className="text-sm font-bold text-slate-500 flex items-center">
                                                <span className="bg-slate-100 px-2 py-0.5 rounded text-xs mr-3">{selectedOrder.id}</span>
